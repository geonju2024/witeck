...
Transformer authentication model.

Same authentication architecture as before.
This version additionally saves G1~G5 authentication checkpoints for
the all-model two-stage experiment.
"""
...
def main():
    ...
    save_dir = model_dir(paths, "transformer")
    ...
    print("\n" + "=" * 112)
    print("Transformer - AUTHENTICATION FINAL TEST")
    print("=" * 112)
    print(
        f"{'Gesture':<9}{'Owner':<8}"
